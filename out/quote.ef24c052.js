...
$(document).ready(function () {
  ...
  var emperorQuotes = ["Young fool... Only now, at the end, do you understand... \n-The Emperor", "Your feeble skills are no match for the power of the Dark Side. \n-The Emperor", "Now, you will pay the price for your lack of vision! \n-The Emperor", "I will make it legal. \n-Darth Sidious"];
  var miscQuotes = ["Many Bothans died to bring us this information. \n-Mon Mothma", "Charming to the last. You don't know how hard I found it, signing the order to terminate your life. \n-Governor Tarkin", "It's a trap! \n-Admiral Ackbar", "So this is how liberty dies…with thunderous applause. \n-Padmé Amidala", "He's no good to me dead. \n-Boba Fett", "I've got a bad feeling about this. \n-Various characters in Star Wars", "May the force be with you. \n-Various characters in Star Wars"];
  var quoteArray = [// Obi-Wan Kenobi Quotes
  obiwanQuotes, // Darth Vader Quotes
  darthvaderQuotes, // Yoda Quotes
  yodaQuotes, // Luke Skywalker Quotes
  lukeskywalkerQuotes, // Han Solo Quotes
  hansoloQuotes, // Princess Leia Organa Quotes
  leiaQuotes, // C-3PO Quotes
  c3poQuotes, // Emperor / Darth Sidious Quotes
  emperorQuotes, // Miscellaneous Quotes
  miscQuotes];
